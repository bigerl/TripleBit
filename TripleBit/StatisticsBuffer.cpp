...
Status OneConstantStatisticsBuffer::decodeAndInsertID(const unsigned char *begin, const unsigned char *end,
...
bool TwoConstantStatisticsBuffer::findID(unsigned value1, Triple *&pos, Triple *&posLimit) {//find by the value1
	int left = 0, right = posLimit - pos;
	int middle = 0;
	bool hit = false;
