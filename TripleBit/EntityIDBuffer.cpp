...
Status
EntityIDBuffer::mergeSingleBuffer(EntityIDBuffer *entbuffer, EntityIDBuffer *entbuffer1, EntityIDBuffer *entbuffer2) {
...
Status
EntityIDBuffer::mergeBuffer(ID *destBuffer, ID *buffer1, ID *buffer2, size_t length1, size_t length2, int IDCount,
                            int key) {
	size_t i, j;
	i = 0;
	j = 0;
