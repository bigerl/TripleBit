...
public:
	...
	void
	Join(EntityIDBuffer *entBuffer1, EntityIDBuffer *entBuffer2, int joinKey1, int joinKey2, bool secondModify = true);
...
struct SortMergeJoinArg {
	...
	SortMergeJoinArg(ID *_buffer1, ID *_buffer2, int _length1, int _length2, char *flag1, char *flag2, int IDCount1,
	                 int IDCount2,
	                 int joinKey1, int joinKey2) : buffer1(_buffer1), buffer2(_buffer2), length1(_length1),
	                                               length2(_length2),
	                                               flag1(flag1), flag2(flag2), IDCount1(IDCount1), IDCount2(IDCount2),
	                                               joinKey1(joinKey1), joinKey2(joinKey2) {}
};
