...
private:
	...
	Status
	findSubjectIDAndPredicateIDByPredicateAndObject(ID predicateID, ID objectID, EntityIDBuffer *buffer, ID minID,
	                                                ID maxID);
	...
	Status
	findObjectIDAndPredicateIDByPredicateAndSubject(ID predicateID, ID subjectID, EntityIDBuffer *buffer, ID minID,
	                                                ID maxID);
	...
	Status
	findSOByKnowBufferTask1(ID preID, ID *p, size_t length, EntityType knowElement, EntityIDBuffer *resultBuffer);

	Status
	findOSByKnowBufferTask1(ID preID, ID *p, size_t length, EntityType knowElement, EntityIDBuffer *resultBuffer);
